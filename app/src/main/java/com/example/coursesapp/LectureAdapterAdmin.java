...
public class LectureAdapterAdmin extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public LectureAdapterAdmin(Context context, List<Lecture> lectureList,ClickHandle clickHandle) {
